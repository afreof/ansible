...
def main():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            krbprincipalname=dict(type='list', required=False),
            krbprincipalexpiration=dict(type='str', required=False),
            ...
            facsimiletelephonenumbermultivalued=dict(type='list', required=False),
